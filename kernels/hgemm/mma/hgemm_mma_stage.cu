...
// 128x128, mma2x4, warp4x4x2(64,32,32), stages, block swizzle, dsmem, reg double buffers
#define LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_X4_KERNEL(stages, stride)   \
{                                                                                     \
  const int smem_max_size = (                                                         \
    (stages) * BM * (BK + A_PAD) * WARP_TILE_K * sizeof(half) +                       \
    (stages) * BK * (BN + B_PAD) * WARP_TILE_K * sizeof(half));                       \
...
void hgemm_mma_m16n8k16_mma2x4_warp4x4x2_stages_dsmem_x4(
  ...
  if (swizzle) {
    ...
    {
    case 2: // ~35KB
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_X4_KERNEL(2, swizzle_stride);
      break;
    case 3: // ~51KB
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_X4_KERNEL(3, swizzle_stride);
      break;
    case 4: // ~68KB  
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_X4_KERNEL(4, swizzle_stride);
      break;
    case 5: // ~85KB
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_X4_KERNEL(5, swizzle_stride);
      break;
    default:
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_X4_KERNEL(2, swizzle_stride);
      break;
...
// use ldmatrix.x4.trans for matrix B smem -> reg
// 128x128, mma2x4, warp4x4x2(64,32,32), stages, block swizzle, dsmem, reg double buffers
#define LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_RR_KERNEL(stages, stride)   \
{                                                                                     \
  const int smem_max_size = (                                                         \
    (stages) * BM * (BK + A_PAD) * WARP_TILE_K * sizeof(half) +                       \
    (stages) * BK * (BN + B_PAD) * WARP_TILE_K * sizeof(half));                       \
...
void hgemm_mma_m16n8k16_mma2x4_warp4x4x2_stages_dsmem_rr(
  ...
  if (swizzle) {
    ...
    {
    case 2: // ~35KB
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_RR_KERNEL(2, swizzle_stride);
      break;
    case 3: // ~51KB
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_RR_KERNEL(3, swizzle_stride);
      break;
    case 4: // ~68KB  
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_RR_KERNEL(4, swizzle_stride);
      break;
    case 5: // ~85KB
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_RR_KERNEL(5, swizzle_stride);
      break;
    default:
      LAUNCH_16816_STAGE_SWIZZLE_MMA2x4_WARP4x4x2_DSMEM_RR_KERNEL(2, swizzle_stride);
      break;
