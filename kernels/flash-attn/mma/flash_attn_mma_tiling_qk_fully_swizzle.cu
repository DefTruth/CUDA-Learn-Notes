...
flash_attn_mma_stages_split_q_tiling_qk_fully_swizzle_kernel(half* Q, 
                                                             half* K, 
                                                             half* V, 
                                                             half* O, 
                                                             int QKV_seqlen,
...
void launch_flash_attn_mma_stages_split_q_tiling_qk_fully_swizzle(
  ...
  cudaFuncSetAttribute(
    flash_attn_mma_stages_split_q_tiling_qk_fully_swizzle_kernel<
      kHeadDim, 
      kMmaAtomM, 
      kMmaAtomN, 
      kMmaAtomK, 
...
void flash_attn_mma_stages_split_q_tiling_qk_fully_swizzle(torch::Tensor Q, 
  ...
  if (stages > 1) {
    ...
    {
    case 32:
      launch_flash_attn_mma_stages_split_q_tiling_qk_fully_swizzle<32,   2>(Q, K, V, O);
      break;
    case 64:
    ...
    {
    case 32:
      launch_flash_attn_mma_stages_split_q_tiling_qk_fully_swizzle<32,   1>(Q, K, V, O);
      break;
    case 64:
