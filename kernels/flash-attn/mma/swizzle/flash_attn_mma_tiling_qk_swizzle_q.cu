...
flash_attn_mma_stages_split_q_tiling_qk_swizzle_q_kernel(half* Q, 
                                                         half* K, 
                                                         half* V, 
                                                         half* O, 
                                                         int QKV_seqlen,
...
void launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q(
...
void flash_attn_mma_stages_split_q_tiling_qk_swizzle_q(torch::Tensor Q, 
  ...
  if (stages > 1) {
    ...
    {
    case 32:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<32,   2>(Q, K, V, O);
      break;
    case 64:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<64,   2>(Q, K, V, O);
      break;
    case 96:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<96,   2>(Q, K, V, O);
      break;
    case 128:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<128,  2>(Q, K, V, O);
      break;
    case 256:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<256,  2>(Q, K, V, O);
      break;
    case 512:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<512,  2>(Q, K, V, O);
      break;
    case 1024:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<1024, 2>(Q, K, V, O);
      break;
    default:
    ...
    {
    case 32:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<32,   1>(Q, K, V, O);
      break;
    case 64:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<64,   1>(Q, K, V, O);
      break;
    case 96:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<96,   1>(Q, K, V, O);
      break;
    case 128:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<128,  1>(Q, K, V, O);
      break;
    case 256:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<256,  1>(Q, K, V, O);
      break;
    case 512:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<512,  1>(Q, K, V, O);
      break;
    case 1024:
      launch_flash_attn_mma_stages_split_q_tiling_qk_swizzle_q<1024, 1>(Q, K, V, O);
      break;
    default:
      throw std::runtime_error("headdim not support!");
      break;
