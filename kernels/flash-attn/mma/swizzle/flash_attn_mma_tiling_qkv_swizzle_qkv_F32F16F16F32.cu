...
flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv_kernel(half* Q, 
                                                                    half* K, 
                                                                    half* V, 
                                                                    half* O, 
                                                                    int QKV_seqlen,
        ...
        for (int tile_V_Bc = 0; tile_V_Bc < (Bc / kMmaAtomK); ++tile_V_Bc) {
          ...
          uint32_t lane_smem_V_ptr = (
            smem_V_base_ptr + (smem_sel_v * V_tile_size + 
                               ...
                               swizzle_permuted_V_j<kMmaAtomN * 2>(
                                lane_smem_V_Bc, lane_smem_V_d)) * sizeof(half)
          );
...
void flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv(torch::Tensor Q, 
                                                                  torch::Tensor K, 
                                                                  torch::Tensor V, 
                                                                  torch::Tensor O, 
                                                                  int stages) {
  ...
  if (stages > 1) {
    ...
    {
    case 32:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<32,   2>(Q, K, V, O);
      break;
    case 64:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<64,   2>(Q, K, V, O);
      break;
    case 96:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<96,   2>(Q, K, V, O);
      break;
    case 128:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<128,  2>(Q, K, V, O);
      break;
    case 256:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<256,  2>(Q, K, V, O);
      break;
    case 512:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<512,  2>(Q, K, V, O);
      break;
    case 1024:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<1024, 2>(Q, K, V, O);
      break;
    default:
    ...
    {
    case 32:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<32,   1>(Q, K, V, O);
      break;
    case 64:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<64,   1>(Q, K, V, O);
      break;
    case 96:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<96,   1>(Q, K, V, O);
      break;
    case 128:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<128,  1>(Q, K, V, O);
      break;
    case 256:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<256,  1>(Q, K, V, O);
      break;
    case 512:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<512,  1>(Q, K, V, O);
      break;
    case 1024:
      launch_flash_attn_mma_stages_split_q_tiling_qkv_acc_f32_swizzle_qkv<1024, 1>(Q, K, V, O);
      break;
    default:
      throw std::runtime_error("headdim not support!");
      break;
