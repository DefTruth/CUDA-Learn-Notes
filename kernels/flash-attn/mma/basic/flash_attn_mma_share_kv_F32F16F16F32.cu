...
flash_attn_mma_stages_split_q_shared_kv_acc_f32_kernel(half* Q, 
                                                       half* K, 
                                                       half* V, 
                                                       half* O, 
                                                       int QKV_seqlen,
...
void launch_flash_attn_mma_stages_split_q_shared_kv_acc_f32(
...
void flash_attn_mma_stages_split_q_shared_kv_acc_f32(torch::Tensor Q, 
  ...
  if (stages > 1) {
    ...
    case 96:
      ...
      break;
    case 128:
      launch_flash_attn_mma_stages_split_q_shared_kv_acc_f32<128, 2>(Q, K, V, O);
      break;
    default:
    ...
    case 96:
      ...
      break;
    case 128:
      launch_flash_attn_mma_stages_split_q_shared_kv_acc_f32<128, 1>(Q, K, V, O);
      break;
    case 256:
      launch_flash_attn_mma_stages_split_q_shared_kv_acc_f32<256, 1>(Q, K, V, O);
      break;
    default:
      throw std::runtime_error("headdim not support!");
      break;
