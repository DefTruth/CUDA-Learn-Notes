...
// 128x128 mma4x2, warp2x4(32,64) w dynamic smem, 98304=96KB < Ampere, Ada, Hopper ...
#define LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(stages, stride)  \
{                                                                                \
...
void hgemm_wmma_m16n16k16_mma4x2_warp2x4_stages_dsmem(
  ...
  if (swizzle) {
    ...
    {
    case 2: // ~17KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(2, swizzle_stride);
      break;
    case 3: // ~26KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(3, swizzle_stride);
      break;
    case 4: // ~34K
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(4, swizzle_stride);
      break;
    case 5: // ~43KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(5, swizzle_stride);
      break;
    case 6: // ~51KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(6, swizzle_stride);
      break;
    default:
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP2x4_KERNEL(2, swizzle_stride);
      break;
...
// 256x256, mma4x4, warp4x4(64,64,16) w dynamic smem, 98304=96KB < Ampere, Ada, Hopper ...
#define LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x4_WARP4x4_KERNEL(stages, stride)  \
{                                                                                \
  const int smem_max_size = (                                                    \
    (stages) * BM * (BK + A_PAD) * sizeof(half) +                                \
    (stages) * BK * (BN + B_PAD) * sizeof(half));                                \
...
// 256x256, mma4x4, warp4x4(64,64,16) stages, dynamic smem, w/o block swizzle across N dim
void hgemm_wmma_m16n16k16_mma4x4_warp4x4_stages_dsmem(
  ...
  if (swizzle) {
    ...
    {
    case 2: // ~33KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x4_WARP4x4_KERNEL(2, swizzle_stride);
      break;
    case 3: // ~50KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x4_WARP4x4_KERNEL(3, swizzle_stride);
      break;
    case 4: // ~66KB
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x4_WARP4x4_KERNEL(4, swizzle_stride);
      break;
    default:
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x4_WARP4x4_KERNEL(2, swizzle_stride);
      break;
...
#define LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP4x4_KERNEL(stages, stride)   \
{                                                                                 \
  const int smem_max_size = (                                                     \
    (stages) * BM * (BK + A_PAD) * sizeof(half) +                                 \
    (stages) * BK * (BN + B_PAD) * sizeof(half));                                 \
...
void hgemm_wmma_m16n16k16_mma4x2_warp4x4_stages_dsmem(
  ...
  if (swizzle) {
    ...
    {
    case 2: 
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP4x4_KERNEL(2, swizzle_stride);
      break;
    case 3: 
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP4x4_KERNEL(3, swizzle_stride);
      break;
    case 4: 
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP4x4_KERNEL(4, swizzle_stride);
      break;
    case 5: 
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP4x4_KERNEL(5, swizzle_stride);
      break;
    default:
      LAUNCH_161616_STAGE_SWIZZLE_DSMEM_MMA4x2_WARP4x4_KERNEL(2, swizzle_stride);
      break;
