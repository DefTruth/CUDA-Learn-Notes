...
run_benchmark(lib.dot_prod_f32_acc_with_f32,   a, b, "f32f32")
run_benchmark(lib.dot_prod_f32x4_acc_with_f32, a, b, "f32x4f32")
run_benchmark(torch.dot, a, b , "f32f32_th")

print("-" * 80)
a_f16 = a.half()
b_f16 = b.half()
run_benchmark(lib.dot_prod_f16_acc_with_f32,   a_f16, b_f16, "f16f32")
run_benchmark(lib.dot_prod_f16x2_acc_with_f32, a_f16, b_f16, "f16x2f32")
