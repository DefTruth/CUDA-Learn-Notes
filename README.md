...
|[[LLM推理优化][KV Cache优化]🔥MQA/GQA/YOCO/...笔记: 层内和层间KV Cache共享](https://zhuanlan.zhihu.com/p/697311739)|@DefTruth|
...
| [[推理部署][CV]🔥升级版NanoDet-Plus MNN/TNN/NCNN/ORT C++工程记录](https://zhuanlan.zhihu.com/p/450586647)|@DefTruth|  
...
- [[推理部署][CV]🤓美团 YOLOv6 ORT/MNN/TNN/NCNN C++推理部署](https://zhuanlan.zhihu.com/p/533643238)
...
- [[推理部署][CV]👿1Mb!头部姿态估计: FSANet，一个小而美的模型(C++)](https://zhuanlan.zhihu.com/p/447364201)
...
- [[推理部署][CV]🔥详细记录MGMatting之MNN、TNN和ORT C++移植](https://zhuanlan.zhihu.com/p/442949027)
...
- [[推理部署][ORT]🤓如何使用ORT C++ API处理NCHW和NHWC输入？](https://zhuanlan.zhihu.com/p/524230808)
...
- [[技术随笔][ML]📒《统计学习方法-李航: 笔记-从原理到实现-基于R》](https://zhuanlan.zhihu.com/p/684885595)
...
| [[cute系列详解][GEMM]📖GEMM流水线: single-stage、pipelined、multi-stage](https://zhuanlan.zhihu.com/p/712451053)|@Titus|
...
- [[cute系列详解][Swizzle]📖cutlass swizzle机制解析（二）(@Titus)](https://zhuanlan.zhihu.com/p/711398930)
